...
export default function AppointmentsList() {
  ...
  const [expandedId, setExpandedId] = useState(null); // For expandable rows
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-end gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-50">
        <div className="space-y-2">
          ...
          <div className="relative">
            <input
              ...
              readOnly
              className="pl-4 pr-10 py-2 border border-gray-200 rounded-lg text-sm font-semibold text-gray-700 w-44 focus:outline-none"
            />
        ...
        <button className="ml-auto bg-[#7B61FF] text-white px-8 py-2 rounded-lg font-bold text-sm">
          Clear
        </button>
      </div>
